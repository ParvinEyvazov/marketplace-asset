...
export async function commentAdder(trigger_data) {
    ...
    let product_data = await Bucket.data.get(PRODUCT_BUCKET_ID, bucket_data.product);
...
export async function commentDeleter(trigger_data) {
    ...
    if (
        ...
        patch_data.rating_count = patch_data.rating_count - 1;
        patch_data.rating_average = patch_data.rating_average ? patch_data.rating_average : 0;
    }
